...
void main(){
  ...
  print("t4.member_a1, a2 : ${t4.member_a1}, ${t4.member_a2}");

  // 호출되는 생성자에 값을 전달한다.
  var t5 = TestClass4();
  print("t5.member_a1 : ${t5.member_a1}");
  // private 변수이긴 하나 같은 파일이므로 사용이 가능하다.
  print("t5.member_a2 : ${t5._member_a2}");

  t5.showMember();

  // 다른 파일에 있는 클래스로 객체를 생성한다.
  var t100 = TestClass100();
  print("t100.test100_a1 : ${t100.text100_a1}");
  // 다른파일에 있는 클래스로 만든 객체의 private 변수는 접근불가능하다.
  // print("t100.test100_a2 : ${t100._text100_a2}");
...
class TestClass3{
  ...
  // 맴버 변수에 값을 담는 코드만 있는 생성자는 간략하게 한 줄로 작성이 가능하다.
