void main(){
  ...
  // 만약 전달할 함수 내부의 코드가 return 값 형태만 있다면 람다식으로 사용이 가능하다.
  function5(100, 200, (v1, v2){
    return v1 + v2;
  });
...
// 반환 값 : 반환 값이 있으면 반환 값의 타입을 적어주고 없으면 void를 작성해주세요
int test_function(){
  return 100;
}
...
// 함수를 매개변수로 받는 함수 (코틀린에서는 고차함수, 익명함수)
